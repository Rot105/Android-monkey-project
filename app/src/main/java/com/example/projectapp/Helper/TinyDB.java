...
public class TinyDB {
    ...
    public ArrayList<GunDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<GunDomain> playerList =  new ArrayList<GunDomain>();

        for(String jObjString : objStrings){
            GunDomain player  = gson.fromJson(jObjString,  GunDomain.class);
    ...
    public void putListObject(String key, ArrayList<GunDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(GunDomain player: playerList){
